...
@Component({
  selector: 'app-product-list-item-extended',
  templateUrl: './product-list-item-extended.component.html',
  styleUrls: ['./product-list-item-extended.component.css']
})
export class ProductListItemExtendedComponent implements OnInit {
